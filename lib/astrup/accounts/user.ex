defmodule Astrup.Accounts.User do
  use Ecto.Schema
  ...
  defp validate_email(changeset, opts) do
    ...
    if Keyword.get(opts, :validate_email, true) do
      changeset
      |> unsafe_validate_unique(:email, Astrup.Repo)
  ...
  """
  def valid_password?(%Astrup.Accounts.User{hashed_password: hashed_password}, password)
