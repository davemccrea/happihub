          ...
          repo.insert_all(
            ...
            [
              ...
              %{
                ...
                anion_gap: Decimal.new("12.8"),
                hemoglobin: Decimal.new("142"),
                oxygen_content: Decimal.new("11.8"),
                oxygen_saturation: Decimal.new("88.5"),
                carboxyhemoglobin: Decimal.new("2.1"),
                methemoglobin: Decimal.new("0.8"),
                potassium: Decimal.new("4.3"),
                sodium: Decimal.new("139"),
                ionized_calcium: Decimal.new("1.16"),
                ionized_calcium_corrected_to_ph_7_4: Decimal.new("1.18"),
                chloride: Decimal.new("101"),
              ...
              %{
                ...
                anion_gap: Decimal.new("22.1"),
                hemoglobin: Decimal.new("148"),
                oxygen_content: Decimal.new("17.8"),
                oxygen_saturation: Decimal.new("96.2"),
                carboxyhemoglobin: Decimal.new("0.7"),
                methemoglobin: Decimal.new("0.9"),
                potassium: Decimal.new("5.2"),
                sodium: Decimal.new("132"),
                ionized_calcium: Decimal.new("1.08"),
                ionized_calcium_corrected_to_ph_7_4: Decimal.new("1.16"),
                chloride: Decimal.new("88"),
                glucose: Decimal.new("24.8"),
              ...
              %{
                ...
                hemoglobin: Decimal.new("126"),
                oxygen_content: Decimal.new("17.1"),
                ...
                ionized_calcium: Decimal.new("1.24"),
                ionized_calcium_corrected_to_ph_7_4: Decimal.new("1.19"),
                chloride: Decimal.new("104"),
                glucose: Decimal.new("4.9"),
