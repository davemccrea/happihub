...
#
#     PHX_SERVER=true bin/astrup start
#
...
if(config_env() == :prod) do
  ...
  host = System.get_env("PHX_HOST") || "happihub.net"
  port = String.to_integer(System.get_env("PORT") || "4000")

  config :astrup, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")
